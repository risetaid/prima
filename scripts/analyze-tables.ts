 ...
 * Usage: bun scripts/analyze-tables.ts
 * 
...
async function main() {
  ...
  try {
    ...
    log('   Indexes should now be considered by the query planner.', colors.cyan);
    log('\n📊 Check index usage: bun scripts/check-index-usage.ts', colors.cyan);
