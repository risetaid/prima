          ...
          if (logResult[0].reminderScheduleId) {
            ...
            if (scheduleResult.length > 0) {
              ...
              if (scheduleResult[0].customMessage) {
                try {
                  ...
                  // If medication parsing fails, just skip it - not all reminders have structured medication data
                  console.warn(
                    "Failed to parse medication details from reminder message:",
                    error
                  );
            ...
            if (!medicationDetails) {
              try {
                ...
                console.warn(
                  "Failed to get medication details for completed reminder:",
                  error
                );
              }
            }
