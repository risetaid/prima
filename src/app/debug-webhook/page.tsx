      ...
      <main className="px-3 sm:px-4 py-4 sm:py-6 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              ...
              <span className="text-xs sm:text-sm text-gray-600 flex items-center gap-2">
                ...
                {isLoading && <div className="w-3 h-3 sm:w-4 sm:h-4 border-2 border-blue-500 border-t-transparent rounded-full animate-spin"></div>}
              </span>
            </div>
        ...
        <div className="space-y-4">
          ...
          {webhookLogs.length === 0 ? (
            ...
            webhookLogs.map((log) => (
              <div key={log.id} className="bg-white rounded-lg p-3 sm:p-4 shadow-sm">
                <div className="flex justify-between items-start mb-3">
                  <div className="flex items-center space-x-2">
                    <span className="inline-block w-2 h-2 sm:w-3 sm:h-3 bg-green-500 rounded-full"></span>
                    <span className="font-medium text-gray-900 text-sm sm:text-base">New Message</span>
                  </div>
