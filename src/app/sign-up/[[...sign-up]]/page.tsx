      ...
      <div className="w-full max-w-md">
        ...
        <SignUp
          appearance={{
            ...
            layout: {
              logoImageUrl: "data:image/svg+xml;base64,",
        ...
        <div className="text-center mt-6 space-y-2">
          ...
          <p className="text-xs text-gray-400">
            Bergabung sebagai relawan PRIMA 💙
          </p>
        </div>
      </div>
    </div>
