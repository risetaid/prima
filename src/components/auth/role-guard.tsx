...
export function RoleGuard({
  ...
  useEffect(() => {
    if (
      isLoaded &&
      userRole &&
      !allowedRoles.includes(userRole as "RELAWAN" | "ADMIN" | "DEVELOPER")
    ) {
      ...
      if (
        ...
        toast.error("Akses Ditolak", {
          description:
            "Anda tidak memiliki akses ke halaman ini. Butuh role ADMIN atau DEVELOPER.",
        });
      } else {
        toast.error("Akses Ditolak", {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center bg-white p-8 rounded-lg shadow-sm max-w-md">
          ...
          <p className="text-gray-600 mb-4">
            ...
            {allowedRoles.includes("DEVELOPER") && " Butuh role DEVELOPER."}
            {allowedRoles.includes("ADMIN") &&
              !allowedRoles.includes("DEVELOPER") &&
              " Butuh role ADMIN."}
          </p>
