...
import { Clock, Zap, ChevronDown, Repeat } from "lucide-react";
  ...
  return (
    <>
                                        ...
                                        {categoryTemplates.map((template) => (
                                          ...
                                          >
                                            ...
                                            <div className="text-xs text-gray-500 truncate">
                                              {template.templateText.substring(
                                                0,
                                                50
                                              )}
                                              ...
      ...
      <Dialog
        ...
        onOpenChange={setIsCustomRecurrenceOpen}
      >
          ...
          <div className="flex space-x-3 p-4 border-t flex-shrink-0">
            ...
            <button
              onClick={() => {
                ...
                toast.info(
                  "Mode pilih tanggal dinonaktifkan karena pengulangan kustom diaktifkan"
                );
              }}
