...
export const PatientVariableCreateSchema = z.object({
  ...
  variableCategory: z
    .enum(["PERSONAL", "MEDICAL", "CAREGIVER", "HOSPITAL", "OTHER"])
    .default("PERSONAL"),
  variableMetadata: z
    .record(
      z.string(),
...
export type ManualConfirmationCreateData = z.infer<
  typeof ManualConfirmationCreateSchema
>;
...
export type PatientVariableCreateData = z.infer<
  typeof PatientVariableCreateSchema
>;
